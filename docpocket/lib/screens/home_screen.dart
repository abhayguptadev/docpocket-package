      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            TextField(
              onChanged: (value) =>
                  context.read<AppProvider>().updateSearchQuery(value),
          ...
          ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                ...
                title: Text(doc.name),
                subtitle: Text(
                  "In ${cat?.name ?? 'Unknown'} • ${doc.fileSize}",
                ),
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "Added ${doc.dateAdded.day} ${_getMonth(doc.dateAdded.month)}",
                          style: const TextStyle(
                            fontSize: 10,
                            color: Colors.grey,
                          ),
          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                subtitle: const Text("This will delete all documents inside"),
                onTap: () {
                  Navigator.pop(context);
  ...
  void _confirmDeleteCategory(BuildContext context, CategoryModel category) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          "Are you sure you want to delete '${category.name}' and all its documents?",
        ),
        actions: [
          TextButton(
